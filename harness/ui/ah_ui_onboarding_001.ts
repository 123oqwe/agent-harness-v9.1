/** AH-UI-ONBOARDING-001: Onboarding UI State Adapter */
...
export function getOnboardingUIState(session: DurableSession, secretsBroker?: SecretsBroker): OnboardingUIState {
