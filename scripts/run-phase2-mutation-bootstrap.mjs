...
export const verifyNativeCleanInstallFixture = ({ snapshot, parent }) => {
  ...
  const version = spawnSync(npmExecutable, ["--version"], { encoding: "utf8", env, shell: false });
  if (version.status !== 0 || version.stdout.trim() !== "10.8.2") throw new Error("native fixture requires npm@10.8.2");
