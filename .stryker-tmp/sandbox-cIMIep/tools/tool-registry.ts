...
const SCHEMA_PATH = join(process.cwd(), 'spec/contracts/tool-spec.schema.json');

function loadSchema(): object {
  const p = existsSync(SCHEMA_PATH) ? SCHEMA_PATH : join(process.cwd(), '..', 'spec/contracts/tool-spec.schema.json');
